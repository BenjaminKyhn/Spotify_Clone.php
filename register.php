...
<div id="inputContainer">
    ...
    <form id="registerForm" action="register.php" method="POST">
        ...
        <p>
            ...
            <input id="email" name="email" type="email" placeholder="email@example.com" value="<?php getInputValue('email');?>" required>
        </p>
        <p>
            <label for="email2">Confirm Email</label>
            <input id="email2" name="email2" type="email" placeholder="email@example.com" value="<?php getInputValue('email2');?>" required>
        </p>
        <p>
